...
from PyQt6.QtCore import Qt, QPropertyAnimation, pyqtProperty, QDate, QSettings, QTimer,QThread, pyqtSignal, QObject
from PyQt6.QtGui import QLinearGradient, QColor, QPainter, QPen, QFont, QPixmap, QIcon
import re
import pycountry
...
online = True
port = 8080
API_BASE_URL = 'https://www.queendahyun.com/api' if online else 'http://127.0.0.1:8000/api'
print(API_BASE_URL)
...
class UserDataFetcher(QObject):
    user_data_fetched = pyqtSignal(dict)
...
class FuturisticAuthWindow(QWidget):
    ...
    def start_google_signin(self):
        ...
        webbrowser.open(f"https://www.queendahyun.com/singing_google")
